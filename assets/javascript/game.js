...
$(document).ready(function() {
    ...
    var characters = {
      "Dragon": {
        ...
        health: 120,
        attack: 8,
        imageUrl: "assets/media/images/dragon.gif",
        enemyAttackBack: 15
      },
      "Ice Dragon": {
        name: "Ice Dragon",
        health: 100,
        attack: 14,
        imageUrl: "assets/media/images/iceDragon.gif",
        enemyAttackBack: 5
      },
      "Queen of Dragons": {
        ...
        health: 150,
        attack: 8,
        imageUrl: "assets/media/images/queenDragon.gif",
        enemyAttackBack: 20
      },
      "Walker King": {
        name: "Walker King",
        health: 180,
        attack: 7,
        imageUrl: "assets/media/images/whiteWalkerKing.gif",
        enemyAttackBack: 25
      }
    };
    ...
    var restartGame = function(resultMessage) {
      ...
      var gameState = $("<div class='groupTitle'>").text(resultMessage);
  
      // Render the restart button and victory/defeat message to the main (element type not the name of.
      $("main").append(gameState);
      $("main").append(restart);
    };
